...
document.addEventListener('DOMContentLoaded', () => {
    ...
    InstitucionesConfirmacion = new bootstrap.Modal(document.getElementById('mdlConfirmacion'), {
        backdrop: 'static'
    });
    ...
    function confirmarEliminar(userId) {
        // Mostrar el modal de confirmación
        InstitucionesConfirmacion.show();

        // Configurar el evento de confirmación
        $('#btnConfirmar').on('click', function () {
            // Ocultar el modal de confirmación
            InstitucionesConfirmacion.hide();
