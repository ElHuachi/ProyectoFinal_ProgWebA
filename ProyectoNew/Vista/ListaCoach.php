            ...
            <tbody>
                ...
                if($coach){
                    foreach($coach as $coachItem){
                        ...
                        "<td>",
                        "<a class='btn btn-primary' href='../Login/RegistroUsuario.php?id=" . $coachItem->NombreC . "'>Editar</a>",
                        "<button class='btn btn-danger btn-eliminar' onclick='confirmar(" . $coachItem->NombreC . "\")'>Eliminar</button>",
                                "</td>",
                                "</tr>";
                    }
                }
